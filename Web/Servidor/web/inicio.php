    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-3">    
            <div class="minijuegosOut">
                    <div class="card">
                        <img href="./accesibilidad.php" src="./imagenes/accesibility.png"  class="card-img-top "alt="">
                        <div class="card-body">
        ...
        <div class="col-sm-3">    
            <div class="minijuegosOut">
                    <div class="card">
                        <img href="./nube.php" src="./imagenes/nube.png"  class="card-img-top" alt="">
                        <div class="card-body">
        ...
        <p>&nbsp</p>
            <div class="row">
                <div class="col-sm-4">
                    <div class="minijuegosOut">
                            <div class="card">
                                <img href="./ganzua.php" class="card-img-top" src="./imagenes/safe_box.png" alt="">
                                <div class="card-body">
                ...
                <div class="col-sm-4">   
                    <div class="minijuegosOut">
                        <div class="card">
                            <img href="./voces.php" class="card-img-top" src="./imagenes/earphone.png" alt="">
                            <div class="card-body">
                ...
                <div class="col-sm-4">    
                    <div class="minijuegosOut">
                            <div class="card">
                                <img href="./formas.php" class="card-img-top" src="./imagenes/geometry.png" alt="">
                                <div class="card-body">
            ...
            <div class="col-sm-2"></div>
                <div class="col-sm-4">    
                    <div class="minijuegosOut">
                            <div class="card">
                                <img href="./puntos.php" class="card-img-top" src="./imagenes/diana.png" alt="">
                                <div class="card-body">
                ...
                <div class="col-sm-4">    
                    <div class="minijuegosOut">
                            <div class="card">
                                <img href="./simon.php" class="card-img-top" src="./imagenes/simondice.png" alt="">
                                <div class="card-body">
