...
?>             
                ...
                <li class="no-display-movil">
                    ...
                    <label class="switch" for="mode" id="switch-label" aria-label="Cambio de contraste de la página" title="Cambio de contraste de la página">
                        <input type="checkbox" id="mode"  name="mode" aria-label="Cambiar el contraste de la página" title="Cambio de contraste de la página" checked role="checkbox" aria-checked="true" aria-labelledby="switch-label"> 
