        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 order-lg-2 col-sm-12 order-sm-2">
                    <img class="minijuegos-img" src="./imagenes/accesibilidad1.png"  alt="Imagen de una pantalla de móvil con una mano tocándola de izquierda a derecha"/>
                </div>
                <div class="col-lg-4 order-lg-3 col-sm-12 order-sm-4">
                    <img class="minijuegos-img" src="./imagenes/accesibilidad2.png"  alt="Imagen de una pantalla de móvil con una mano tocandola en el centro"/>
                </div>
